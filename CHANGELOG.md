## 1.1.0 — Письмо перед книгой

- Добавлена отдельная страница `/prologue` для первого QR-кода в физической книге.
- Первый лист содержит личное письмо, подпись и единственную кнопку «Продолжить».
- После нажатия открывается финальный лист без перехода в цифровую книгу; небольшая стрелка позволяет вернуться к письму.
- Страница изолирована от основной навигации, закрыта от индексации и отсутствует в sitemap.
- Композиция адаптирована для мобильных экранов iPhone 11–17 с учётом safe-area и уменьшенной анимации.
